...
@RestController
@RequestMapping("/api/to-do-kafka")
public class ToDoKafkaResource {
    private final Logger log = LoggerFactory.getLogger(ToDoKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public ToDoKafkaResource(KafkaProperties kafkaProperties) {
